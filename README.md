...
> **买 NFT → 做人格测试 → 结果永久刻在链上石碑**

## 概念

将爆火的 SBTI 人格测试与 NFT 结合：
- 🎫 **Mint NFT** — 购买一张空白灵魂卡片（Soul Card）
- 📝 **做测试** — 31道题，15维度人格分析
- 🪦 **生成石碑** — 测试结果永久上链，NFT 变成你的灵魂石碑（Soul Stele）
- 🎨 **链上 SVG** — 根据人格类型动态生成独一无二的石碑图片
...
```
用户连接钱包 → Mint NFT (空白卡片 / Soul Card)
     ↓
开始答题 (31道题)
     ↓
前端计算 15 维度分数
...
调用合约 inscribe() → 结果上链
     ↓
NFT 从空白卡片(Soul Card) → 灵魂石碑(Soul Stele) (链上 SVG)
     ↓
