...
// 人格配色（避开金色，金色仅用于金卡/金碑系统）
function getPersonalityColor(index) {
  const colors = [
    '#e94560','#ff6b35','#888888','#c9a227','#ff69b4',
    '#ff4444','#00ff88','#ff69b4','#ff6b9d','#ffb6c1',
    '#9b59b6','#95a5a6','#8B4513','#7bff3a','#00ffff',
    '#4169e1','#dc143c','#708090','#cd853f','#c17817',
...
function getPersonalityColor2(index) {
  const colors = [
    '#0f3460','#cc4400','#444444','#8b6914','#ff1493',
    '#cc0000','#009955','#8b008b','#c44569','#ff69b4',
    '#6c3483','#7f8c8d','#D2691E','#228b22','#0099cc',
    '#1e3a8a','#8b0000','#2f4f4f','#8b7355','#8b5a00',
